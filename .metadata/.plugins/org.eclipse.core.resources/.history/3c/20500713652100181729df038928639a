...
public class Lab16e
{
	...
	{
		Histogram test = new Histogram(new char[]{'a','b','c'},"H:\\APCSA_github\\APCSA\\Unit10\\src\\lab16e1.dat");
		...
		Histogram test1 = new Histogram(new char[]{'d','e','a'},"H:\\APCSA_github\\APCSA\\Unit10\\src\\lab16e2.dat");
		...
		Histogram test2 = new Histogram(new char[]{'x','a','r','g'},"H:\\APCSA_github\\APCSA\\Unit10\\src\\lab16e3.dat");
